namespace DesktopSprites.Collections
{
    ...
    public sealed class AsyncLinkedList<T> : ICollection<T>
    {
        ...
        /// <summary>
        /// Enumerates the elements of a <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.
        /// </summary>
        public struct Enumerator : IEnumerator<T>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1.Enumerator"/> struct
            /// for the given <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.
            /// </summary>
            /// <param name="collection">The <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/> to enumerate.</param>
            ...
            /// <summary>
            /// Releases all resources used by the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1.Enumerator"/> object.
            /// </summary>
            public void Dispose()
            {
                enumerator.Dispose();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/> class that is empty.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/> class that contains elements
        ...
        /// <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.</param>
        ...
        /// <summary>
        /// Gets the number of nodes actually contained in the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.
        /// </summary>
        public int Count
        {
            get
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/> is read-only.
        /// </summary>
        ...
        /// <summary>
        /// Gets the first node of the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the last node of the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.
        /// </summary>
        ...
        /// <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemAdded"/> event using <paramref name="value"/>.
        /// </summary>
        ...
        /// order to add a range of items to the collection. The <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemsAdded"/>
        ...
        /// <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemsAdded"/> event is then raised.
        /// </summary>
        /// <param name="addMethod">The method which adds an item to the underlying collection.</param>
        ...
        /// <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemRemoved"/> event using <paramref name="value"/>.
        /// </summary>
        ...
        /// <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/> synchronously. The
        /// <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemRemoved"/> event will be raised once the value is
        /// removed. The event will not be raised if the value was not removed, or if the value was not found in the original
        /// <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.
        /// </summary>
        /// <param name="item">The object to remove from the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.
        /// </param>
        /// <returns>Return true if <paramref name="item"/> was successfully removed from the
        /// <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>; otherwise, false. This method also returns false if
        /// <paramref name="item"/> is not found in the original <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.
        /// </returns>
        ...
        /// <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemsRemoved"/> event will be raised once the elements are
        /// removed.
        /// </summary>
        ...
        /// <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>. This method is performed asynchronously. The
        /// <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemAdded"/> event will be raised once the value is added.
        /// </summary>
        /// <param name="value">The value to add at the start of the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.</param>
        public void AddFirst(T value)
        {
            Add(() => list.AddFirst(value), value);
        }
        /// <summary>
        /// Adds a new node containing the specified value at the end of the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.
        /// This method is performed asynchronously. The <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemAdded"/> event will
        /// be raised once the value is added.
        /// </summary>
        /// <param name="value">The value to add at the end of the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.</param>
        public void AddLast(T value)
        {
            Add(() => list.AddLast(value), value);
        }
        /// <summary>
        /// Adds the specified nodes at the start of the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>. This method is
        /// performed asynchronously. The <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemsAdded"/> event will be raised
        ...
        /// <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.</exception>
        ...
        /// <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>. This method is performed asynchronously. The
        /// <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemsAdded"/> event will be raised once the values are
        /// added.
        /// </summary>
        ...
        /// <summary>
        /// Adds the specified new nodes at the end of the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>. This
        /// method is performed asynchronously. The <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemsAdded"/>
        ...
        /// <summary>
        /// Removes all nodes from the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/> asynchronously. This method
        /// is performed asynchronously. The <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemsRemoved"/> event
        ...
        /// <summary>
        /// Determines whether a value is in the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.
        /// </summary>
        /// <param name="value">The value to locate in the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>. The
        /// value can be null for reference types.</param>
        /// <returns>Returns true if <paramref name="value"/> is found in the
        /// <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>; otherwise, false.</returns>
        ...
        /// <summary>
        /// Copies the entire <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/> to a compatible one-dimensional
        ...
        /// that is the destination of the elements copied from <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>. The
        ...
        /// <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/> is greater than the available space from the index produced by 
        ...
        /// </summary>
        /// <param name="value">The value to locate in the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.</param>
        ...
        /// <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.
        /// </summary>
        /// <param name="value">The value to remove from the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.
        /// </param>
        ...
        /// The <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemsRemoved"/> event will be raised once the elements are
        ...
        /// <summary>
        /// Removes the node at the start of the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>. This method is
        /// performed asynchronously. The <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemRemoved"/> event will be
        /// raised once the node is removed.
        /// </summary>
        /// <exception cref="T:System.InvalidOperationException">The
        /// <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/> is empty.</exception>
        public void RemoveFirst()
        {
            Remove(list.RemoveFirst, list.First.Value);
        }
        /// <summary>
        /// Removes the node at the end of the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>. This method is
        /// performed asynchronously. The <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemRemoved"/> event will be
        /// raised once the node is removed.
        /// </summary>
        /// <exception cref="T:System.InvalidOperationException">The
        ...
        /// <summary>
        /// Sorts the elements in the entire <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/> using the default
        /// comparer.
        /// </summary>
        public void Sort()
        {
        ...
        /// <summary>
        /// Sorts the elements in the entire <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/> using the specified
        ...
        /// <summary>
        /// Adds an item to the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/> synchronously. The
        /// <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemAdded"/> event will be raised once the item is added.
        /// </summary>
        /// <param name="item">The object to add to the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.</param>
        void ICollection<T>.Add(T item)
        {
            AddSync(() => ((ICollection<T>)list).Add(item), item);
        }
        /// <summary>
        /// Removes all nodes from the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/> synchronously. The
        /// <see cref="E:DesktopSprites.Collections.AsyncLinkedList`1.ItemsRemoved"/> event will be raised once the collection
        /// is cleared.
        /// </summary>
        ...
        /// that is the destination of the elements copied from <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.
        /// The
        ...
        /// <exception cref="T:System.ArgumentException">The number of elements in the source
        /// <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/> is greater than the available space from
        ...
        /// <summary>
        /// Provides a debugger view for an <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1"/>.
        /// </summary>
        private sealed class DebugView
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="T:DesktopSprites.Collections.AsyncLinkedList`1.DebugView"/>
            /// class.
            /// </summary>
