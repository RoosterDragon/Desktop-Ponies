namespace DesktopSprites.Collections
{
    ...
    public sealed class LazyDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/> class that is empty, has the
        ...
        /// <summary>
        /// Gets the number of key/value pairs contained in the <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/>.
        /// </summary>
        public int Count
        {
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/> is read-only. Returns false.
        /// </summary>
        ...
        /// <summary>
        /// Gets a collection containing the keys in the <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets an enumerator which iterates over only keys in the <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/> whose
        ...
        {
            get { return Enumerable.Create(GetUninitializedEnumerator); }
        }
        /// <summary>
        ...
        /// <summary>
        /// Gets a collection containing the values in the <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/>.
        /// </summary>
        ...
        #region Methods
        /// <summary>
        /// Adds the specified key to the <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/>.
        /// </summary>
        ...
        /// <summary>
        /// Removes all keys and values from the <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/>.
        /// </summary>
        public void Clear()
        {
            InitializedCount = 0;
        ...
        /// <summary>
        /// Determines whether the <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/> contains the specified key.
        /// </summary>
        ...
        /// <summary>
        /// Copies the elements of the <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/> to an <see cref="T:System.Array"/>,
        ...
        /// <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/>. The <see cref="T:System.Array"/> must have zero-based indexing.
        /// </param>
        ...
        /// <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/> is greater than the available space from
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/>. Uninitialized
        ...
        /// <summary>
        /// Initializes all of the uninitialized items in the <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/>.
        /// </summary>
        ...
        /// <summary>
        /// Removes the value with the specified key from the <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/>.
        /// </summary>
        ...
        /// not found in the <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/>.</returns>
        /// <exception cref="T:System.ArgumentNullException"><paramref name="key"/> is null.</exception>
        ...
        /// <summary>
        /// Removes all of the uninitialized items in the <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/>.
        /// </summary>
        ...
        /// <summary>
        /// Provides a debugger view for a <see cref="T:DesktopSprites.Collections.LazyDictionary`2"/>.
        /// </summary>
