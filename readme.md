...
There are over 260 ponies and other characters from the show included. There is also a wide array of OCs available and you can create your own ponies too.
...
* [Download the latest version (v1.59)](https://github.com/RoosterDragon/Desktop-Ponies/releases/download/v1.59/Desktop.Ponies.v1.59.zip)
* Extract the files.
