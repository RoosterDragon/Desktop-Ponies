...
There are over 240 ponies and other characters from the show included. There is also a wide array of OCs available and you can create your own ponies too.
...
* [Download the latest version (v1.56)](https://github.com/RoosterDragon/Desktop-Ponies/releases/download/v1.56/Desktop.Ponies.v1.56.zip)
* Extract the files.
